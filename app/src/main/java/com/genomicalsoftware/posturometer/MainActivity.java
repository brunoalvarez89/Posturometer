...
public class MainActivity extends AppCompatActivity
    ...
    //region Main Loop
    private void mainLoop(float[] sensorData) {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        mainLoop(sensorEvent.values.clone());
    }

    private void lowPass(float[] values) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.genomicalsoftware.posturometer.R.layout.activity_main);
        setupSlidingUI();
        loadPreferences();
    }
    ...
    private void setupActionBar() {
        // Inflate Toolbar
        Toolbar toolbar = (Toolbar) findViewById(com.genomicalsoftware.posturometer.R.id.tool_bar);
    ...
    private void setupSlidingTabs() {
        // Inflate ViewPager
        ViewPager viewPager = (ViewPager) findViewById(com.genomicalsoftware.posturometer.R.id.pager);
        ...
        // Inflate Tabs
        SlidingTabLayout slidingTabs = (SlidingTabLayout) findViewById(com.genomicalsoftware.posturometer.R.id.tabs);
        slidingTabs.setDistributeEvenly(true);
        // Set Indicator Color
        slidingTabs.setCustomTabColorizer(new SlidingTabLayout.TabColorizer() {
            @Override
            public int getSelectedTextColor(int position) {
                return ContextCompat.getColor(getApplicationContext(), com.genomicalsoftware.posturometer.R.color.colorPrimaryLighter70);
            }

            @Override
            public int getUnselectedTextColor(int position) {
                return ContextCompat.getColor(getApplicationContext(), com.genomicalsoftware.posturometer.R.color.colorPrimaryLighter30);
            }
        });
